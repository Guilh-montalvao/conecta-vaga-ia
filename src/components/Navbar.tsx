  ...
  return (
    ...
    >
      <div className="container mx-auto flex justify-between items-center">
        <a href="#" className="text-xl font-bold text-conecta-blue flex items-center">
        ...
        <a href="#howworks" className="bg-conecta-blue text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors">
          Começar
        </a>
      </div>
    </nav>
